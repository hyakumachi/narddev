      ...
      <div className="about-description">
        <h2>
          <span className='intro intro-bold'>
            Hello!👋 — I'm a developer based in the Philippines with a strong interest in web and mobile technologies.
          </span>
          <span className='intro intro-normal'>
            {" "} I'm currently focused on full stack development and database administration, with the goal of building scalable and reliable software solutions.
          </span>
        </h2>
      </div>
    </div>
